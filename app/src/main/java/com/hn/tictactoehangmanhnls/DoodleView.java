...
public class DoodleView extends View {
    ...
    private final Paint paintLine2; // used to draw lines onto bitmap
    private final Paint paintLine3; // used to draw lines onto bitmap
    ...
    public void setDrawingColor1(int color) {
        paintLine2.setColor(color);
    }

    public void setDrawingColor2(int color) {
        paintLine3.setColor(color);
    }
    ...
    public int getDrawingColor1() {
        return paintLine2.getColor();
    }

    public int getDrawingColor2() {
        return paintLine3.getColor();
    }
    ...
    public void setImage(Bitmap b) {
        Log.d("ADebugTag", "Value: " + "We hitting homie");
        final Paint paint = new Paint();

        bitmapCanvas.drawBitmap(b, getMatrix(),paint);
    }
}